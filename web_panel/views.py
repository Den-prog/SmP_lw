...
from .patterns import (
    SingletonRouter, RewardFactory, 
    CartCalculator, SimplePriceCalculationStrategy, VolunteerDiscountStrategy,
    DjangoSQLiteAdapter, MongoDatabaseAdapter
)
...
def patterns_demo_view(request):
    ...
    calculator.set_strategy(VolunteerDiscountStrategy())
